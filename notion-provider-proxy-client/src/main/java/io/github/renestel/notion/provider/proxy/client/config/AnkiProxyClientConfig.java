...
@Configuration
@EnableRetry
public class AnkiProxyClientConfig extends HttpClientConfigurer {
    ...
    @Bean
    public NotionProviderProxy createAnkiProxy(
        ...
        return new NotionProviderProxyClient(uriBuilderFactory, properties, restClient, "anki");
    }
}
